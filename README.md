...
# Demo
Visit http://localhost:8089/xterm/ in your browser to see the web terminal connected to the server shell.
...
4. Visit http://localhost:8089/xterm/ in your browser.
